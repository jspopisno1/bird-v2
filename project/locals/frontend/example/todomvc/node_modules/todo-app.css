...
.todo-list .todo .toggle:after {
    content: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="-10 -18 100 135"><circle cx="50" cy="50" r="50" fill="none" stroke="#ededed" stroke-width="3"/></svg>');
}

.todo-list .todo .toggle:checked:after {
...
.todo-list .todo .destroy:after {
    content: '×';
}

.todo-list .todo:hover .destroy {
    display: block;
}
...
.todo-list .todo.editing:last-child {
    margin-bottom: -1px;
}
